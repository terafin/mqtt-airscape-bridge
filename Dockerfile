...
##   $ docker build -t node-js-for-terafin-mqtt-airscape-bridge .
##
## RUNNING
##   $ docker run -p 3000:3000 node-js-for-terafin-mqtt-airscape-bridge
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="a1udxrv" \
    STACKSMITH_STACK_NAME="Node.js for terafin/mqtt-airscape-bridge" \
